...
where n=no of observations, p = number of variables.

3) We refer to the weights $\phi_{ip}$ as __Loadings__.The loadings make up the principal components loading vector.
