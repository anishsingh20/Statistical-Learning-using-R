...
The only __drawback__ PCA has is that it generates the principal components in a __unsupervised__ manner i.e without using the __target__ values ,hence the principal components which explain the most variation in dataset without target-$Y$,might or might not explain good percentage of variance in the response variable$Y$. 