...
####So by using the lm() function too we can get a Genaralized Additive Model. 


####Hence GAMs are a very nice technique and method to Model Non linearities and Learn complex function other than just Linear functions.And the most basic idea behind learning Non Linearities is to transform the Data and the variables which can capture and Learn make sense of something more complicated than just a linear relationship.  
